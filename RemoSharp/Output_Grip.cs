...
namespace RemoSharp
{
    public class Output_Grip : GH_Component
    {
        ...
        /// </summary>
        public Output_Grip()
          : base("Output_Grip_Item", "out_gr_item",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddGenericParameter("Output_Data_I", "Item", "Automatically grips the data output of the closest C# component based on the output index", GH_ParamAccess.item);
        ...
        {
            pManager.AddGenericParameter("component_Output_Item", "Item_Out_Data", "Automatically outputs the data coming from the 'Output_Data' input", GH_ParamAccess.item);
        }
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return RemoSharp.Properties.Resources.Output_Icons_Item.ToBitmap();
            }
        }
        ...
        {
            get { return new Guid("7c99d494-bed1-4652-b0a4-725d955810ff"); }
        }
    }
}