...
namespace RemoSharp
{
    public class Output_Grip_Tree : GH_Component
    {
        ...
        /// </summary>
        public Output_Grip_Tree()
          : base("Output_Grip_Tree", "out_gr_tree",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddGenericParameter("Output_Data_T", "Tree", "Automatically grips the data output of the closest C# component based on the output index", GH_ParamAccess.tree);
        ...
        {
                pManager.AddGenericParameter("component_Output_Tree", "Tree_Out_Data", "Automatically outputs the data coming from the 'Output_Data' input", GH_ParamAccess.tree);
        }
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return RemoSharp.Properties.Resources.Output_Icons_Tree.ToBitmap();
            }
        }
        ...
        {
            get { return new Guid("abfc378e-425e-4033-b603-7562d45f7cb4"); }
        }
    }
}